...
<div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                      <h5 class="mb-0">Media Player Ibo Contact Detail</h5>
                    </div>
                    <div class="card-body">
                      <form method="POST" action="{{ url('/mediaIbo-contact-details') }}">
                      {{ csrf_field() }}
                      @foreach ($ContactDetail as $cont)
                        ...
                        <div class="mb-3">
                          ...
                          <textarea type="text" class="form-control" name="info" 
                           id="basic-default-fullname" placeholder="Your Info">{{ $cont->info }}</textarea>
                        </div>
